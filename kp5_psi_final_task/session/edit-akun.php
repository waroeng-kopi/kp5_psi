    ...
    <section class="hero d-flex align-items-center justify-content-center text-center" id="hero" style="top: 80px;">
        ...
        <div class="d-flex flex-column border border-dark p-5 pt-4 pb-4 rounded-4 gap-2">
          ...
          ?>
            ...
            <div class="w-auto mx-auto my-auto d-flex justify-content-between" style="min-width: 300px">
              ...
              <input type="text" name="tipeAkun" value="<?php echo $row['tipeAkun'] ?>">
            </div>
            <div class="w-auto mx-auto my-auto d-flex justify-content-between" style="min-width: 300px">
              <label for="saldoAwal">saldoAwal : </label>
              <input type="text" name="saldoAwal" value="<?php echo $row['saldoAwal'] ?>">
            </div>
            <input type="submit" name="update" value="update" class="d-flex mx-3 my-auto mt-3 px-5 py-2 bg-success text-white rounded-4 border-0">
      ...
      <?php 
        ...
        if (isset($_POST['update'])) {
          ...
          $connection->query("UPDATE user SET nama='$nama', deskripsi='$deskripsi', tipeAkun='$tipeAkun', saldoAwal='$saldoAwal' WHERE userId=$userId");
